...
.scan-target-group input[type="text"] {
  padding: 8px 10px;
    ...
    <div class="panel">
      ...
      <?php if ($lastScan): ?>
        <table class="scan-last-table" style="width:auto;border-collapse:collapse;">
          <tr>
            <td>ID</td>
            <td class="mono"><?= h($lastScan['id']) ?></td>
          </tr>
          <tr>
            <td>Status</td>
            <td>
              <span class="status-pill <?= scan_status_class($lastScan['status']) ?>">
                <?= h($lastScan['status']) ?>
              </span>
            </td>
          </tr>
          ...
          <tr>
            <td>Base path</td>
            <td><code class="rule-pattern"><?= h($lastScan['base_path'] ?? '—') ?></code></td>
          </tr>
          <tr>
            <td>Nalazi</td>
            <td><strong><?= h($lastScan['files_found'] ?? '—') ?></strong></td>
          </tr>
        </table>
      <?php else: ?>
          ...
          <table>
            ...
            <?php foreach ($requests as $r): ?>
              <tr>
                ...
                <td>
                  <span class="status-pill <?= scan_status_class($r['status']) ?>">
                    <?= h($r['status']) ?>
                  </span>
                </td>
